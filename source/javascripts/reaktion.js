...
var $author$project$Reaktion$initialModel = {G: $elm$core$Maybe$Nothing, M: $elm$core$Maybe$Nothing, H: $elm$core$Maybe$Nothing, A: _List_Nil, w: 1, I: $elm$core$Maybe$Nothing, J: $elm$core$Maybe$Nothing, K: false, L: $elm$core$Maybe$Nothing};
...
var $author$project$Reaktion$ShowPoint = {$: 5};
			...
			case 3:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							J: $elm$core$Maybe$Just(showAfter)
						}),
			...
			case 1:
				...
				var duration = A2(
					...
					A4(
						...
						model.L,
						model.J));
				var durations = A2($elm$core$List$cons, duration, model.A);
					...
					_Utils_update(
						$author$project$Reaktion$initialModel,
						{
							G: $elm$core$Maybe$Just(
								$elm$core$Basics$round(sum / model.w)),
							M: clickedAt,
							H: $elm$core$Maybe$Just(duration),
							A: durations,
							w: model.w + 1
						}),
...
var $author$project$Reaktion$Start = {$: 0};
...
var $author$project$Point$Clicked = 0;
...
var $author$project$Reaktion$viewField = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				function () {
				var _v0 = _Utils_Tuple2(model.K, model.I);
				if (_v0.a && (!_v0.b.$)) {
					var p = _v0.b.a;
					return A2(
						$elm$html$Html$map,
	...
	return $author$project$Utils$propertiesTable(
		_List_fromArray(
			[
				...
				$elm$html$Html$text(
					$author$project$Utils$viewInt(model.H))),
				_Utils_Tuple2(
				$elm$html$Html$text('Zeit (Durchschn.)(msecs): '),
				$elm$html$Html$text(
					$author$project$Utils$viewInt(model.G)))
			]));
};
...
var $author$project$Reaktion$main = $elm$browser$Browser$element(
	{aG: $author$project$Reaktion$init, aN: $author$project$Reaktion$subscriptions, aP: $author$project$Reaktion$update, aQ: $author$project$Reaktion$view});
