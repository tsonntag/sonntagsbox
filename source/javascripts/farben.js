...
{
	if (region.Q.G === region.W.G)
	{
		return 'on line ' + region.Q.G;
	}
	return 'on lines ' + region.Q.G + ' through ' + region.W.G;
}
...
var $author$project$Farben$Game = 2;
...
var $author$project$ItemLists$data = _List_fromArray(
	[
		...
		[
			...
			_Utils_Tuple3(2, 'rot', 'magenta'),
			_Utils_Tuple3(3, 'blau', 'red'),
			_Utils_Tuple3(4, 'lila', 'green'),
			_Utils_Tuple3(5, 'gelb', 'green'),
			_Utils_Tuple3(6, 'weiß', 'green'),
			_Utils_Tuple3(7, 'gelb', 'red'),
			_Utils_Tuple3(8, 'weiß', 'magenta'),
			_Utils_Tuple3(9, 'weiß', 'darkorange'),
			_Utils_Tuple3(10, 'lila', 'red'),
			_Utils_Tuple3(11, 'weiß', 'magenta'),
			_Utils_Tuple3(12, 'grün', 'darkorange'),
			_Utils_Tuple3(13, 'weiß', 'green'),
			_Utils_Tuple3(14, 'grün', 'magenta'),
			_Utils_Tuple3(15, 'blau', 'red'),
			_Utils_Tuple3(16, 'lila', 'gold'),
			_Utils_Tuple3(17, 'lila', 'gold'),
			_Utils_Tuple3(18, 'schwarz', 'magenta'),
			_Utils_Tuple3(19, 'gelb', 'magenta'),
			_Utils_Tuple3(20, 'grün', 'green')
		]),
		_List_fromArray(
		[
			_Utils_Tuple3(1, 'blau', 'gold'),
			_Utils_Tuple3(2, 'gelb', 'darkorange'),
			_Utils_Tuple3(3, 'lila', 'darkorange'),
			_Utils_Tuple3(4, 'schwarz', 'black'),
			_Utils_Tuple3(5, 'weiß', 'green'),
			_Utils_Tuple3(6, 'lila', 'green'),
			_Utils_Tuple3(7, 'schwarz', 'green'),
			_Utils_Tuple3(8, 'rot', 'green'),
			_Utils_Tuple3(9, 'weiß', 'green'),
			_Utils_Tuple3(10, 'lila', 'gold'),
			_Utils_Tuple3(11, 'lila', 'red'),
			_Utils_Tuple3(12, 'gelb', 'black'),
			_Utils_Tuple3(13, 'grün', 'darkorange'),
			_Utils_Tuple3(14, 'gelb', 'black'),
			_Utils_Tuple3(15, 'lila', 'magenta'),
			_Utils_Tuple3(16, 'gelb', 'red'),
			_Utils_Tuple3(17, 'rot', 'darkorange'),
			_Utils_Tuple3(18, 'schwarz', 'red'),
			_Utils_Tuple3(19, 'blau', 'black'),
			_Utils_Tuple3(20, 'lila', 'magenta')
		]),
		_List_fromArray(
		[
			_Utils_Tuple3(1, 'schwarz', 'black'),
			_Utils_Tuple3(2, 'grün', 'green'),
			_Utils_Tuple3(3, 'weiß', 'gold'),
			_Utils_Tuple3(4, 'schwarz', 'darkorange'),
			_Utils_Tuple3(5, 'schwarz', 'magenta'),
			_Utils_Tuple3(6, 'gelb', 'black'),
			_Utils_Tuple3(7, 'gelb', 'red'),
			_Utils_Tuple3(8, 'schwarz', 'red'),
			_Utils_Tuple3(9, 'rot', 'red'),
			_Utils_Tuple3(10, 'weiß', 'magenta'),
			_Utils_Tuple3(11, 'grün', 'black'),
			_Utils_Tuple3(12, 'weiß', 'black'),
			_Utils_Tuple3(13, 'weiß', 'black'),
			_Utils_Tuple3(14, 'schwarz', 'red'),
			_Utils_Tuple3(15, 'weiß', 'green'),
			_Utils_Tuple3(16, 'schwarz', 'darkorange'),
			_Utils_Tuple3(17, 'grün', 'black'),
			_Utils_Tuple3(18, 'gelb', 'red'),
			_Utils_Tuple3(19, 'rot', 'gold'),
			_Utils_Tuple3(20, 'blau', 'darkorange')
		]),
		_List_fromArray(
		[
			_Utils_Tuple3(1, 'grün', 'darkorange'),
			_Utils_Tuple3(2, 'lila', 'darkorange'),
			_Utils_Tuple3(3, 'gelb', 'gold'),
			_Utils_Tuple3(4, 'schwarz', 'darkorange'),
			_Utils_Tuple3(5, 'grün', 'green'),
			_Utils_Tuple3(6, 'grün', 'magenta'),
			_Utils_Tuple3(7, 'blau', 'darkorange'),
			_Utils_Tuple3(8, 'lila', 'black'),
			_Utils_Tuple3(9, 'schwarz', 'darkorange'),
			_Utils_Tuple3(10, 'gelb', 'magenta'),
			_Utils_Tuple3(11, 'gelb', 'magenta'),
			_Utils_Tuple3(12, 'grün', 'magenta'),
			_Utils_Tuple3(13, 'lila', 'green'),
			_Utils_Tuple3(14, 'grün', 'black'),
			_Utils_Tuple3(15, 'blau', 'green'),
			_Utils_Tuple3(16, 'rot', 'red'),
			_Utils_Tuple3(17, 'rot', 'red'),
			_Utils_Tuple3(18, 'rot', 'darkorange'),
			_Utils_Tuple3(19, 'lila', 'black'),
			_Utils_Tuple3(20, 'weiß', 'black')
		]),
		_List_fromArray(
		[
			_Utils_Tuple3(1, 'rot', 'gold'),
			_Utils_Tuple3(2, 'rot', 'green'),
			_Utils_Tuple3(3, 'gelb', 'green'),
			_Utils_Tuple3(4, 'gelb', 'black'),
			_Utils_Tuple3(5, 'gelb', 'red'),
			_Utils_Tuple3(6, 'blau', 'gold'),
			_Utils_Tuple3(7, 'weiß', 'black'),
			_Utils_Tuple3(8, 'weiß', 'magenta'),
			_Utils_Tuple3(9, 'blau', 'magenta'),
			_Utils_Tuple3(10, 'lila', 'darkorange'),
			_Utils_Tuple3(11, 'lila', 'black'),
			_Utils_Tuple3(12, 'lila', 'green'),
			_Utils_Tuple3(13, 'schwarz', 'gold'),
			_Utils_Tuple3(14, 'grün', 'darkorange'),
			_Utils_Tuple3(15, 'weiß', 'magenta'),
			_Utils_Tuple3(16, 'rot', 'green'),
			_Utils_Tuple3(17, 'schwarz', 'red'),
			_Utils_Tuple3(18, 'rot', 'magenta'),
			_Utils_Tuple3(19, 'weiß', 'gold'),
			_Utils_Tuple3(20, 'blau', 'green')
		])
	]);
...
var $author$project$Farben$initialModel = {
	...
	u: $author$project$Farben$getItemList($author$project$Farben$initialItemListIndex),
	o: $author$project$Farben$initialItemListIndex,
	L: 2
};
...
var $author$project$Farben$NextItem = {$: 1};
...
var $author$project$Farben$nextCmd = function (model) {
	return A2($author$project$Utils$after, model.t, $author$project$Farben$NextItem);
};
var $author$project$Farben$resetModel = F2(
	function (itemListIndex, model) {
		return _Utils_update(
			...
			{
				B: $elm$core$Maybe$Nothing,
				u: $author$project$Farben$getItemList(itemListIndex),
				o: itemListIndex
			});
	});
		...
		switch (msg.$) {
			case 0:
				...
				var factor = A2(
					$elm$core$Maybe$withDefault,
					model.F,
					$elm$core$String$toFloat(model.z));
				return _Utils_Tuple2(
					A2(
						...
						_Utils_update(
							...
							{
								F: factor,
								z: $elm$core$String$fromFloat(factor),
								A: $elm$core$String$fromInt(interval),
								t: interval,
								B: A2(
									$elm$core$Maybe$andThen,
									$elm$core$List$head,
									$author$project$Farben$getItemList(model.o))
							})),
				...
				if ((!_v1.$) && _v1.a.b) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								t: $elm$core$Basics$ceiling(model.t * model.F),
								B: $elm$core$Maybe$Just(item),
								u: $elm$core$Maybe$Just(rest)
							}),
						$author$project$Farben$nextCmd(model));
				} else {
					return _Utils_Tuple2(
						A2($author$project$Farben$resetModel, model.o, model),
						...
						[
							...
							_List_fromArray(
								[
									...
									$author$project$Farben$SetPage(2))
								]),
							_List_fromArray(
								[
...
var $author$project$Farben$printOneItemList = function (model) {
	var _v0 = _Utils_Tuple2(model.o, model.u);
	if ((!_v0.a.$) && (!_v0.b.$)) {
		var i = _v0.a.a;
		var l = _v0.b.a;
		return A2(
...
var $author$project$Farben$PrintAll = 1;
var $author$project$Farben$PrintOne = 0;
...
var $author$project$Farben$Start = {$: 0};
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$Events$onClick(
									$author$project$Farben$SetPage(0)),
							...
							_List_fromArray(
								[
									$elm$html$Html$Events$onClick(
									$author$project$Farben$SetPage(1)),
									$elm$html$Html$Attributes$class('ml-3')
								]),
							_List_fromArray(
								[
					...
					_List_fromArray(
						[
							$author$project$Farben$viewItem(model.B)
						]))
				]));
	});
...
var $author$project$Farben$main = $elm$browser$Browser$element(
	{aF: $author$project$Farben$init, aM: $author$project$Farben$subscriptions, aO: $author$project$Farben$update, aP: $author$project$Farben$view});
